...
module demo::u256 {
    ...
    public fun from_number2(number: u256) {
        let n = number + 2;
        //

        debug::print(&n)

        // debug::print(vector::borrow(&number, 0));
        // debug::print(vector::borrow(&number, 1));
        // debug::print(vector::borrow(&number, 2));
        // debug::print(vector::borrow(&number, 3));
    }

    public fun from_number1(number: u256) {
        let mask = 0xFFFFFFFFFFFFFFFF;
        //
        let a1 = ((number & mask) as u64);
        let a2 = (((number >> 64) & mask) as u64);
        let a3 = (((number >> 128) & mask) as u64);
        let a4 = (((number >> 192) & mask) as u64);
    ...
    public fun from_number(number: vector<u64>) {
        // let mask: u256 = 0xFFFFFFFFFFFFFFFF;
        //
        // let a1 = (number & mask) as u64;
        // let a2 = ((number >> 64) & mask) as u64;
        // let a3 = ((number >> 128) & mask) as u64;
