...
async function process() {
    console.log(`generate sol bytecode from ${contractName}.sol`)
    ...
    console.log(`generate move file ${contractName}.move`)
    fs.writeFileSync(`./sol_bytecode_to_move_bytecode/move/contract/sources/modules/${contractName}.move`, gen(init_code))
    console.log(`compile move file ${contractName}.move`)
    await runCmd(`aptos move compile --package-dir ./sol_bytecode_to_move_bytecode/move/contract/`)
}
