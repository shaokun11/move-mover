module evm::evm {
    ...
    public entry fun send_tx(
        ...
        if(tx_type == TX_TYPE_LEGACY) {
            ...
            sub_balance(create_resource_address(&@evm, to_32bit(evm_from)), gas * CONVERT_BASE);
    ...
    fun test_deposit_withdraw() acquires Account, ContractEvent {
        ...
        let coin_store_account = borrow_global<Account>(create_resource_address(&@evm, to_32bit(sender)));
        debug::print(&coin_store_account.balance);
