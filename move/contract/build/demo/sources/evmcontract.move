module demo::evmcontract {
    ...
    public fun deploy(account: &signer, sender: vector<u8>, nonce: u256, construct: vector<u8>, value: u256): vector<u8> acquires S {
        ...
        create(account, sender, nonce, construct, value)
    }


    fun create(_account: &signer, sender: vector<u8>, nonce: u256, construct: vector<u8>, value: u256): vector<u8> acquires S {
    ...
    fun testUniswap() acquires S {
        ...
        let usdc_addr = create(&user, sender, 0, init_code, 0);
        ...
        let usdt_addr = create(&user, sender, 1, init_code, 0);
        ...
        let factory_addr = create(&user, sender, 2, factory_code, 0);
        ...
        let router_addr = create(&user, sender, 3, router_code, 0);
